...
namespace AppTest.Controller
{
    ...
    public class WeatherForecastControllerTests
    {
        private readonly Mock<IMapper<WeatherForecastRequestModel, WeatherForecastModel>> _mapperMock =
            new();
        private readonly Mock<ISocialMedia> _socialMediaMock = new();
        private readonly Mock<INewspaper> _newspaperMock = new();
        private readonly Mock<IRadioStation> _radioStationMock = new();
